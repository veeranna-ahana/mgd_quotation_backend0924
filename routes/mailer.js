...
// mailRouter.post('/sendDirectMail1', upload.single("file"), async (req, res, next) => {
//     try {
//         const {  toAddress, ccAddress, fromName, subjectLine, mailBody, mfilename, mpath } = req.body;
//         sendAttachmails( toAddress, ccAddress, fromName, subjectLine, mailBody, {
//             mfilename: req.file.originalname,
//             mpath: req.file.path  
//            // filename: req.file.originalname,
//            // path: req.file.path
//         }, (data) => {
